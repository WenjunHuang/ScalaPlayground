...
class TellThroughputPerformanceSpec extends PerformanceSpec(BenchmarkConfig.config(true)) {

  import akkaperformance.microbench.TellThroughputPerformanceSpec._
