...
import akkacluster.wordscount.JobReceptionist.{JobRequest, JobSuccess}
import akkacluster.wordscount._
...
class LocalWordsSpec extends TestKit(ActorSystem("test")) with WordSpecLike
  with MustMatchers
  with ImplicitSender {
